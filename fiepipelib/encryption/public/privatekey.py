...
class abstractprivatekey(object):
    ...
    def Sign(self, msg, signername):
        ...
        ret = fiepipelib.encryption.public.signature.FromParameters('RSA', signature, signername)
        return ret
...
class networkedsiteprivatekey(abstractprivatekey):
    ...
    def createemptypublickey(self):
        return fiepipelib.encryption.public.publickey.networkedsitepublickey()

class legalentityprivatekey(abstractprivatekey):
    """A private key for a legal entity"""

    def createemptypublickey(self):
        return fiepipelib.encryption.public.publickey.legalentitypublickey()
